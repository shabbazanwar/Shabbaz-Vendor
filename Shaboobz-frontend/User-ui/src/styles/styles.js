const styles = {
    ...
    button: "w-[150px] bg-black h-[50px] my-3 flex items-corner justify-center rounded-xl cursor-pointer",
    cart_button: "px-[20px] h-[38px rounded0[20px] bg-[#f63b60] flex items-corner justify-center cursor-pointer",
    cart_button_text: "text-[#fff] text-[16px] font-[600px]",
